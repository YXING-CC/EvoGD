...
Data_cell, which stores the training and testing EEG samples and their corresponding labels for each fold.

Each EEG trial used by EvoDG has the shape: 100 × 19
